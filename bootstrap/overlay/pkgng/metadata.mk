...
_METADATA_TARGETS+=	${_MANIFEST_FILE}
...
_PKG_CREATE_ARGS+=				-m ${PKG_DB_TMPDIR}
...
_MANIFEST_TARGETS+=	${_BUILD_INFO_FILE}
_MANIFEST_TARGETS+=	${_BUILD_VERSION_FILE}
_MANIFEST_TARGETS+=	${_COMMENT_FILE}
_MANIFEST_TARGETS+=	${_DEPENDS_FILE}
_MANIFEST_TARGETS+=	${_DESCR_FILE}
_MANIFEST_TARGETS+=	${_MESSAGE_FILE}
_MANIFEST_TARGETS+=	${_DEPENDS_PLIST}
_MANIFEST_TARGETS+=	${_PRESERVE_FILE}
_MANIFEST_TARGETS+=	${_SIZE_ALL_FILE}
_MANIFEST_TARGETS+=	${_SIZE_PKG_FILE}
